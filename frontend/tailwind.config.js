...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Ultra-modern space theme with sophisticated gradients
        cosmic: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
      ...
      keyframes: {
        ...
        'glow-intense': {
          ...
          '100%': { 
            boxShadow: '0 0 30px rgba(168, 85, 247, 0.8), 0 0 60px rgba(168, 85, 247, 0.6)' 
          },
        },
        orbit: {
      ...
      backgroundImage: {
        ...
        'nebula-gradient': 'linear-gradient(135deg, #082f49 0%, #0ea5e9 25%, #38bdf8 50%, #0ea5e9 75%, #082f49 100%)',
        'stellar-gradient': 'linear-gradient(135deg, #4a044e 0%, #d946ef 25%, #f0abfc 50%, #d946ef 75%, #4a044e 100%)',
        'aurora-gradient': 'linear-gradient(135deg, #022c22 0%, #10b981 25%, #34d399 50%, #10b981 75%, #022c22 100%)',
      },
      backdropBlur: {
        'xs': '2px',
        'sm': '4px',
      ...
      boxShadow: {
        ...
        'cosmic': '0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 0 0 1px rgba(255, 255, 255, 0.05)',
        'stellar': '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
      },
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
